...
local force = entity.force
    ...
    if (entity.name == "Artifact-collector-area") then --or (entity.name == "item-collector-base-rampant") then
   ...
   --- Terraforming Station has been built
	if entity.valid and entity.name == "TerraformingStation" then
		...
		--T_Station_Container.clear_request_slot(1)
...
local function On_Remove(event)
	...
	--Artifact collector
    if (entity.name == "Artifact-collector") then -- or (entity.name == "item-collector-base-rampant") then
